...
public final class FlightUpdatedEvent extends Event {
    ...
    @JsonCreator
	public FlightUpdatedEvent(@JsonProperty("sequence")Long sequence, @JsonProperty("flightId")UUID flightId, @JsonProperty("origin")String origin,
		...
		super(ApplicationConstant.CAT_FLIGHT, ApplicationConstant.FLIGHT_UPDATED, sequence);
	...
	public String toString() {
		return "FlightUpdatedEvent [flightId=" + flightId + ", origin=" + origin + ", destiny=" + destiny
