...
public class ReservationRedisProjectorAdapter implements ReservationRedisProjectorPort {
	...
	@Override
	public boolean existsReservationRedisEntityByClientId(UUID clientId) {
		
		logInfo("existsReservationRedisEntityByClientId", ApplicationConstant.CLIENTID + " : " + clientId);
		return !reservationRedisRepository.findByClientId(clientId).isEmpty();
