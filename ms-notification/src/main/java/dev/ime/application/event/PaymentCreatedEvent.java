...
public class PaymentCreatedEvent extends Event{
	...
	@JsonCreator
	public PaymentCreatedEvent(@JsonProperty("sequence")Long sequence, @JsonProperty("paymentId")UUID paymentId,
			@JsonProperty("reservationId")UUID reservationId, @JsonProperty("clientId")UUID clientId, @JsonProperty("flightId")UUID flightId) {
		super(ApplicationConstant.CAT_PAY, ApplicationConstant.PAYMENT_CREATED, sequence);
	...
	public String toString() {
		return "PaymentCreatedEvent [paymentId=" + paymentId + ", reservationId=" + reservationId + ", clientId="
