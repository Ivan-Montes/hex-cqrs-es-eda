...
class ReservationRedisRepositoryTest {
	...
	@Test
	void ReservationRedisRepository_findByFlightId_ReturnListEmpty() {
		
		List<ReservationRedisEntity> list = reservationRedisRepository.findByFlightId(UUID.randomUUID());
	...
	@Test
	void ReservationRedisRepository_findByFlightId_ReturnList() {
		
		List<ReservationRedisEntity> list = reservationRedisRepository.findByFlightId(flightId);
