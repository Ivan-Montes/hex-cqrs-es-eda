...
public class KafkaPlaneSubscriberAdapter implements SubscriberPort{
	...
	public KafkaPlaneSubscriberAdapter(LoggerUtil loggerUtil,
	...
	@Override
	@KafkaListener(topics = {ApplicationConstant.PLANE_CREATED, ApplicationConstant.PLANE_UPDATED, ApplicationConstant.PLANE_DELETED}, groupId = "msregistry-consumer-plane")
