...
public class KafkaSeatSubscriberAdapter implements SubscriberPort{
	...
	public KafkaSeatSubscriberAdapter(LoggerUtil loggerUtil,
	...
	@Override
	@KafkaListener(topics = {ApplicationConstant.SEAT_CREATED, ApplicationConstant.SEAT_UPDATED, ApplicationConstant.SEAT_DELETED},	groupId = "msregistry-consumer-seat")	
