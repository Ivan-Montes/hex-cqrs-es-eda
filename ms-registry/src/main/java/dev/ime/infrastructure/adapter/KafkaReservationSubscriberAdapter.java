...
public class KafkaReservationSubscriberAdapter implements SubscriberPort{
	...
	@Override
	@KafkaListener(topics = {ApplicationConstant.RESERVATION_CREATED, ApplicationConstant.RESERVATION_UPDATED, ApplicationConstant.RESERVATION_DELETED}, groupId = "msregistry-consumer-reservation")
