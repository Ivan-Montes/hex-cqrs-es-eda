...
@Component
public class KafkaNotificationSubscriberAdapter implements SubscriberPort{

	private final LoggerUtil loggerUtil;
	private final GenericCommandServicePort<Event> genericCommandServicePort;
	
	public KafkaNotificationSubscriberAdapter(LoggerUtil loggerUtil,
	...
	@Override
	@KafkaListener(topics = {ApplicationConstant.NOTIFICATION_CREATED, ApplicationConstant.NOTIFICATION_UPDATED, ApplicationConstant.NOTIFICATION_DELETED}, groupId = "msregistry-consumer-notification")
