...
public class KafkaPaymentSubscriberAdapter implements SubscriberPort{
	...
	public KafkaPaymentSubscriberAdapter(LoggerUtil loggerUtil,
	...
	@Override
	@KafkaListener(topics = {ApplicationConstant.PAYMENT_CREATED, ApplicationConstant.PAYMENT_UPDATED, ApplicationConstant.PAYMENT_DELETED}, groupId = "msregistry-consumer-payment")
